...
(function() {
  ...
  this._find_faults = function(me, first_only, handler) {
    step((function(_this) {
      return function*(resume) {
        var R, boxed_chart, cmp_name, cmp_trending_idx, i, indexed_chart, indexed_trend, len, messages, ref, ref_chart_idx, ref_name, ref_trend_idx, relation, warn_missing;
