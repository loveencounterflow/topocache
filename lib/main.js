...
(function() {
  ...
  this.add_anchor = function(me, protocol, path) {
  ...
  this.register = function(me, precedent, consequent, fix) {
    ...
    precedent_url = CND.isa_list(precedent) ? (ref = this.URL).from_path.apply(ref, [me].concat(slice.call(precedent))) : precedent;
    consequent_url = CND.isa_list(consequent) ? (ref1 = this.URL).from_path.apply(ref1, [me].concat(slice.call(consequent))) : consequent;
  ...
  this.URL.from_path = (function(_this) {
  ...
  this.URL.from_url = (function(_this) {
