...
(function() {
  ...
  this.get_boxed_trend = function(me, handler) {
    ...
    var R, box, collector, i, j, k, key, len, len1, len2, memo, ref, ref1, ref2, target, timestamp, timestamps;
    R = [];
    collector = new Map();
    memo = me.memo;
    ...
    for (i = 0, len = ref.length; i < len; i++) {
      ...
      for (j = 0, len1 = box.length; j < len1; j++) {
        ...
        debug(key, (ref1 = memo['files']) != null ? (ref2 = ref1[key]) != null ? ref2['timestamp'] : void 0 : void 0);
