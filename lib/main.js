...
(function() {
  ...
  this.align = (function(_this) {
    return function(me, handler) {
      ...
      step(function*(resume) {
        var Z, arity, command, dt, error, fault, fix, kind, method, output, ref, ref1, run, runs, t0, t1, type;
        runs = [];
        Z = {
          runs: runs,
          t0: new Date()
        ...
        while ((fault = (yield _this.find_first_fault(me, resume))) != null) {
          ...
          if ((method = me['aligners'][kind]) != null) {
            ref = (yield method(me, command, resume)), error = ref.error, output = ref.output;
          } else {
            switch (kind) {
              case 'shell':
                ...
                command = command[0];
                ref1 = (yield _this.HELPERS.shell(me, command, resume)), output = ref1.stdout, error = ref1.stderr;
                break;
              default:
  ...
  this.HELPERS._shell_from_list = (function(_this) {
    return function(me, command, handler) {
      var cp, error_lines, parameters, ref, result_lines, settings;
      ...
      cp.on('close', function(code) {
        ...
        return handler(null, result_lines);
      });
      return null;
    };
  })(this);
