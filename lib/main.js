  ...
  this.align = (function(_this) {
    return function(me, handler) {
      ...
      step(function*(resume) {
        var Z, arity, command, dt, error, fault, fix, kind, method, output, ref, run, runs, t0, t1;
        runs = [];
        Z = {
          runs: runs,
          t0: new Date()
