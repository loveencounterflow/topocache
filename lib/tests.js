...
(function() {
  ...
  this["find multiple faults"] = function(T, done) {
    return step((function(_this) {
      return function*(resume) {
        var boxed_trend, fault, faults, fix_1, fix_2, g, i, j, len, len1;
        g = TC.new_cache({
          home: PATH.resolve(__dirname, '../test-data')
        });
        _this._procure_test_files();
  ...
  if (module.parent == null) {
    include = ["create cache object", "register file objects", "find fault(s) (1)", "find fault(s) (non-existent file)", "fix fault(s) (simple case) (1)", "find multiple faults"];
    this._prune();
    this._main();
  }
