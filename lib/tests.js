...
(function() {
  ...
  this["align multiple faults (1)"] = function(T, done) {
    step((function(_this) {
      return function*(resume) {
        var boxed_trend, fault, faults, first_fault, fix, fix_1, fix_2, fix_count, g, i, j, len, len1, output;
        g = TC.new_cache({
          home: PATH.resolve(__dirname, '../test-data')
        });
        _this._procure_test_files();
  ...
  this["align multiple faults (2)"] = function(T, done) {
    step((function(_this) {
      return function*(resume) {
        ...
        T.eq((ref1 = report['runs']) != null ? (ref2 = ref1[0]) != null ? ref2['cause'] : void 0 : void 0, 'g.coffee');
        T.eq((ref3 = report['runs']) != null ? (ref4 = ref3[1]) != null ? ref4['cause'] : void 0 : void 0, 'f.coffee');
