...
(function() {
  ...
  this["find fault(s) (1)"] = function(T, done) {
    step((function(_this) {
      return function*(resume) {
        ...
        g = TC.new_cache({
          home: home,
          stamper: TC.HELPERS.file_stamper
        });
  ...
  this["align multiple faults (1)"] = function(T, done) {
    step((function(_this) {
      return function*(resume) {
        var boxed_trend, command, fault, faults, first_fault, fix, fix_1, fix_2, fix_count, g, i, j, len, len1, output, protocol, ref;
        g = TC.new_cache({
          stamper: TC.HELPERS.file_stamper,
          home: PATH.resolve(__dirname, '../test-data')
        });
  ...
  this["align multiple faults (2)"] = function(T, done) {
    step((function(_this) {
      return function*(resume) {
        var fault, g, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, ref8, report;
        g = TC.new_cache({
          stamper: TC.HELPERS.file_stamper,
          home: PATH.resolve(__dirname, '../test-data')
        });
