...
(function() {
  ...
  this["toposort of fixes"] = function(T, done) {
    step((function(_this) {
      return function*(resume) {
        var fault, faults, fix_1, fix_2, g, i, len;
        g = TC.new_cache({
          home: PATH.resolve(__dirname, '../test-data')
        });
        _this._procure_test_files();
  ...
  if (module.parent == null) {
    include = ["create cache object", "register file objects", "find fault(s) (1)", "find fault(s) (non-existent file)", "find single fault", "find multiple faults", "fix multiple faults", "toposort of fixes"];
    this._prune();
    this._main();
  }
