...
(function() {
  var CND, FS, LTSORT, PATH, TC, badge, debug, echo, help, include, info, log, rpr, step, templates_home, test, test_data_home, touch, urge, warn, whisper,
  ...
  this["fix fault(s) (simple case)"] = function(T, done) {
    return step((function(_this) {
      return function*(resume) {
  ...
  if (module.parent == null) {
    include = ["create cache object", "register file objects", "can not set anchor after adding dependencies", "relative paths are roundtrip-invariant", "file URLs are roundtrip-invariant", "only file URLs are relativized / absolutized", "find fault(s) (simple case)", "fix fault(s) (simple case)"];
    this._prune();
    this._main();
  }
