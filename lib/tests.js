...
(function() {
  ...
  this["fix multiple faults (1)"] = function(T, done) {
    step((function(_this) {
      return function*(resume) {
  ...
  this["fix multiple faults (2)"] = function(T, done) {
    step((function(_this) {
      return function*(resume) {
  ...
  if (module.parent == null) {
    include = ["create cache object", "register file objects", "find fault(s) (1)", "find fault(s) (non-existent file)", "find single fault", "find multiple faults", "fix multiple faults (1)", "fix multiple faults (2)"];
    this._prune();
    this._main();
  }
