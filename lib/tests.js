...
(function() {
  ...
  if (module.parent == null) {
    include = ["create cache object", "register file objects", "can not set anchor after adding dependencies", "relative paths are roundtrip-invariant", "file URLs are roundtrip-invariant", "only file URLs are relativized / absolutized"];
    this._prune();
    this._main();
  }
