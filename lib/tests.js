...
(function() {
  var CND, FS, LTSORT, PATH, TC, badge, debug, echo, help, include, info, log, mkdirp, rimraf, rpr, step, templates_home, test, test_data_home, urge, warn, whisper,
  ...
  this._procure_test_files = function(target_home) {
    var R, byte_count, file_count, filename, i, len, ref, should_remove_folder, source_path, target_path;
    file_count = 0;
  ...
  this["create and use memo object"] = function(T, done) {
    var remove_folder;
    remove_folder = this._procure_test_files('create and use memo object');
    remove_folder();
    done();
    return null;
  };
  ...
  if (module.parent == null) {
    include = ["create and use memo object"];
    this._prune();
    this._main();
  }
