...
(function() {
  ...
  this["register file objects"] = function(T, done) {
    step((function(_this) {
      return function*(resume) {
        ...
        TC.register_fix(g, 'file::f.coffee', 'file::f.js', 'bash::coffee -c test-data');
  ...
  this["register file objects with complex keys"] = function(T, done) {
    ...
    T.throws("expected a text, got a list", function() {
      return TC.register_fix(g, ['file', 'f.coffee'], ['file', 'f.js'], ['bash', 'coffee -c test-data']);
    });
    urge('55444', g);
    done();
    return null;
  ...
  this["find fault(s) (non-existent file)"] = function(T, done) {
    step((function(_this) {
      return function*(resume) {
        ...
        yield TC.HELPERS.touch(g, 'file::f.coffee', resume);
        yield _this._delay(resume);
        TC.register_fix(g, 'file::f.coffee', 'file::no-such-file.js', 'bash::coffee -c test-data');
        try {
      ...
      return function*(resume) {
        ...
        while ((fault = (yield TC.find_first_fault(g, resume))) != null) {
          ...
          if (protocol === 'bash') {
            ...
            T.fail("expected protocol to be 'bash', got " + (rpr(protocol)) + " from key " + (rpr(fail)));
          }
  ...
  if (module.parent == null) {
    include = ["fixes can be strings, lists"];
    this._prune();
    this._main();
  }
