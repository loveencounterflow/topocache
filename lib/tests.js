...
(function() {
  ...
  if (module.parent == null) {
    include = ["create cache object", "register file objects", "register file objects with complex keys", "find fault(s) (1)", "find fault(s) (non-existent file)", "find single fault", "find multiple faults", "align multiple faults (1)", "align multiple faults (2)", "fixes can be strings, lists"];
    this._prune();
    this._main();
  }
